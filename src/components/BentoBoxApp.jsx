...
// Redesigned PromptPal Bento Component
const BentoBoxApp = () => {
  return (
    <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 mt-80">
      {" "}
      {/* Changed mt-32 to mt-48 */}
      {/* Left column */}
