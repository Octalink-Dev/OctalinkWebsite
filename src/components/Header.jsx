...
import Octalink_2 from "/src/assets/Octalink_2.png";
...
const Header = () => {
  ...
  const handleClick = (e, url) => {
    ...
    // Extract the element id from the url
    const elementId = url.replace("#", "");
    // Use the global scrollToElement function
  ...
  return (
    ...
    >
      <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
        ...
        >
          <img src={Octalink_2} width={190} height={40} alt="Octalink" />
        </a>
